...
/**
 * MySQL / TiDB schema extractor using JDBC metadata + information_schema.
 */
public class MySqlSchemaExtractor implements SchemaExtractor {
    ...
    public MySqlSchemaExtractor(ErDatasource ds) {
        this.ds = ds;
    }
    ...
    private TableMeta getTableInternal(Connection conn, String schema, String table) throws Exception {
        ...
        try (PreparedStatement ps = conn.prepareStatement(
            ...
            try (ResultSet rs = ps.executeQuery()) {
                if (rs.next()) {
                    ...
                    if (collation != null) {
                        // mysql collation name contains charset as prefix
        ...
        // MySQL中，catalog对应database，schema为null

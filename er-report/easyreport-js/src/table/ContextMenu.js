    ...
    return {
        callback: function (key, options) {
            ...
            if (key === 'insert_row_above') {
                ...
                renderRowHeader(this,context);
                setDirty();
            }else if(key==='page_break_after'){
                const selected=this.getSelected();
                const startRow=selected[0],endRow=selected[2];
                const context=this.context;
                for(let rowNumber=startRow;rowNumber<=endRow;rowNumber++){
                    context.addRowHeader(rowNumber,null,true);
                }
                renderRowHeader(this,context);
                setDirty();
        ...
        items: {
            "insert_row_above": {
                name: `<i class="easyreport easyreport-insertrow" style="color: #3344d3;font-size: 13px"></i> ${window.i18n.table.contextMenu.insertRowUp}`
            },
            "insert_row_below": {
                name: `<i class="easyreport easyreport-insertrow" style="color: #3344d3;font-size: 13px"></i> ${window.i18n.table.contextMenu.insertRowDown}`
            },
            "insert_col_left": {
                name: `<i class="easyreport easyreport-insert-column" style="color: #008ed3;font-size: 13px"></i> ${window.i18n.table.contextMenu.insertColBefore}`
            },
            "insert_col_right": {
                name: `<i class="easyreport easyreport-insert-column" style="color: #008ed3;font-size: 13px"></i> ${window.i18n.table.contextMenu.insertColAfter}`
            },
            "del_row": {
                name: `<i class="easyreport easyreport-deleterow" style="color: #d30a16;font-size: 13px"></i>  ${window.i18n.table.contextMenu.delRow}`,
                disabled:checkRowDeleteOperationDisabled
            },
            "del_col": {
                name: `<i class="easyreport easyreport-deletecolumn" style="color: #d30a16;font-size: 13px"></i>  ${window.i18n.table.contextMenu.delCol}`,
                disabled:checkColDeleteOperationDisabled
            },
            "row_height": {
                name: `<i class="easyreport easyreport-height" style="color: #d30a16;font-size: 13px;font-weight:bold"></i>  ${window.i18n.table.contextMenu.rowHeight}`,
                disabled:checkRowDeleteOperationDisabled
            },
            "col_width": {
                name: `<i class="easyreport easyreport-width" style="color: #d30a16;font-size: 13px;font-weight:bold"></i>  ${window.i18n.table.contextMenu.colWidth}`,
                disabled:checkColDeleteOperationDisabled
            },
            "title_row": {
                name: `<i class="easyreport easyreport-title" style="color: #9C27B0;font-size: 13px"></i>  ${window.i18n.table.contextMenu.title}`,
                disabled:checkRowDeleteOperationDisabled
            },
            "repeat_row_header": {
                name: `<i class="easyreport easyreport-header-repeat" style="color: #9C27B0;font-size: 13px"></i>  ${window.i18n.table.contextMenu.repeatHeader}`,
                disabled:checkRowDeleteOperationDisabled
            },
            "repeat_row_footer": {
                name: `<i class="easyreport easyreport-footer-repeat" style="color: #9C27B0;font-size: 13px"></i>  ${window.i18n.table.contextMenu.repeatFooter}`,
                disabled:checkRowDeleteOperationDisabled
            },
            "summary_row": {
                name: `<i class="easyreport easyreport-summary" style="color: #9C27B0;font-size: 13px"></i>  ${window.i18n.table.contextMenu.summary}`,
                disabled:checkRowDeleteOperationDisabled
            },
            "repeat_cancel": {
            ...
            "page_break_after": {
                name: `<i class="glyphicon glyphicon-share-alt" style="color: #9C27B0;font-size: 13px"></i>  翻页行`,
                disabled:checkRowDeleteOperationDisabled
            },
            "copy_style": {
                name: `<i class="easyreport easyreport-copy" style="color: #d30e00;font-size: 13px"></i>  ${window.i18n.table.contextMenu.copy}`,
                disabled:checkCopyOperationDisabled
            },
            "paste_style": {
                name: `<i class="easyreport easyreport-paste" style="color: #d30e00;font-size: 13px"></i>  ${window.i18n.table.contextMenu.paste}`,
                disabled:checkPasteOperationDisabled
            },
            "clean_content": {
                name: `<i class="easyreport easyreport-clean-content" style="color: #007471;font-size: 13px"></i>  ${window.i18n.table.contextMenu.clearContent}`,
                disabled:checkCleanOperationDisabled
            },
            "clean_style": {
                name: `<i class="easyreport easyreport-clean-style" style="color: #00746f;font-size: 13px"></i>  ${window.i18n.table.contextMenu.clearStyle}`,
                disabled:checkCleanOperationDisabled
            },
            "clean": {
                name: `<i class="easyreport easyreport-clean" style="color: #d30e00;font-size: 13px"></i>  ${window.i18n.table.contextMenu.clearAll}`,
                disabled:checkCleanOperationDisabled
            }
        }
    };

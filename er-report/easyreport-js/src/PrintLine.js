...
export default class PrintLine{
    constructor(context){
        ...
        const rightHr=$(`<hr title="打印线" class="easyreport-right-hr-for-print" style="height: ${height}px;width:0px;border-left:dashed 1px #999999;position: absolute;left: 300pt;top: 35px;z-index: 10">`);
    ...
    refresh(){
        ...
        $('.easyreport-right-hr-for-print').css('left',width+"pt");
    }
};
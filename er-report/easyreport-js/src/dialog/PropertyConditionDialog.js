...
export default class PropertyConditionDialog{
    ...
    _initProperty(container){
        ...
        const configBorderButton=$(`<button type="button" class="btn btn-default" style="padding: 1px 8px;"><i class="easyreport easyreport-setting"></i> ${window.i18n.dialog.propCondition.borderConfig}</button>`);

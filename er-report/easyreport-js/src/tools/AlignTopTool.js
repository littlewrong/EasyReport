...
export default class AlignTopTool extends Tool{
    ...
    buildButton(){
        ...
        const nameButton=$(`<button type="button" class="btn btn-default"
            ...
            <i class="easyreport easyreport-alignmiddle" id="valign_button" style="color: #0e90d2;"></i>
            </button>`);
        ...
        const top=$(`<li>
                <a href="###">
                    <i class="easyreport easyreport-aligntop" style="color: #0e90d2;"></i> ${window.i18n.tools.alignTop.topAlign}
                </a>
            </li>`);
        top.click(function(){
            const selectedCells=_this.context.hot.getSelected();
        ...
        const middle=$(`<li>
                <a href="###">
                    <i class="easyreport easyreport-alignmiddle" style="color: #0e90d2;"></i> ${window.i18n.tools.alignTop.middleAlign}
                </a>
            </li>`);
        ...
        const bottom=$(`<li>
                <a href="###">
                    <i class="easyreport easyreport-alignbottom" style="color: #0e90d2;"></i> ${window.i18n.tools.alignTop.bottomAlign}
                </a>
            </li>`);
    ...
    refresh(startRow,startCol,endRow,endCol){
        ...
        for(let i=startRow;i<=endRow;i++) {
            for (let j = startCol; j <= endCol; j++) {
                ...
                $("#valign_button").removeClass().addClass("easyreport easyreport-align"+valign);
                this.align=valign;
                break;
            }
            break;
    ...
    _buildCellAlign(context,align,prevAligns){
        ...
        for(let i=startRow;i<=endRow;i++){
            for(let j=startCol;j<=endCol;j++){
                ...
                $("#valign_button").removeClass().addClass("easyreport easyreport-align"+align);
                this.align=align;
            }
        }
        return oldAligns;
    ...
    getIcon(){
        return `<i class="easyreport easyreport-aligntop" style="color: #0e90d2;"></i>`;
    }
}
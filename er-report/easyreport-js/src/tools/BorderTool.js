...
export default class BorderTool extends Tool{
    ...
    buildButton(){
        ...
        const mainBtn=$(`<button type="button" class="btn btn-default dropdown-toggle" style="border:none;border-radius:0;background: #f8f8f8;padding: 6px 5px;" data-toggle="dropdown" title="${window.i18n.tools.border.borderLine}">
            <i class="easyreport easyreport-no-border" style="color: #0e90d2;"></i>
            <span class="caret"></span>
        </button>`);
        const ul=$(`<ul class="dropdown-menu" role="menu"></ul>`);
        const fullBorder=$(`<li>
                <a href="###">
                    <i class="easyreport easyreport-full-border" style="color: #0e90d2;"></i> ${window.i18n.tools.border.allLine}
                </a>
            </li>`);
        ...
        const noBorder=$(`<li>
                <a href="###">
                    <i class="easyreport easyreport-no-border" style="color: #0e90d2;"></i> ${window.i18n.tools.border.noBorder}
                </a>
            </li>`);
        ...
        const leftBorder=$(`<li>
                <a href="###">
                    <i class="easyreport easyreport-left-border" style="color: #0e90d2;"></i> ${window.i18n.tools.border.leftBorder}
                </a>
            </li>`);
        ...
        const rightBorder=$(`<li>
                <a href="###">
                    <i class="easyreport easyreport-right-border" style="color: #0e90d2;"></i> ${window.i18n.tools.border.rightBorder}
                </a>
            </li>`);
        ...
        const topBorder=$(`<li>
                <a href="###">
                    <i class="easyreport easyreport-top-border" style="color: #0e90d2;"></i> ${window.i18n.tools.border.topBorder}
                </a>
            </li>`);
        ...
        const bottomBorder=$(`<li>
                <a href="###">
                    <i class="easyreport easyreport-bottom-border" style="color: #0e90d2;"></i> ${window.i18n.tools.border.bottomBorder}
                </a>
            </li>`);
        ...
        const customBorder=$(`<li>
                <a href="###">
                    <i class="easyreport easyreport-full-border" style="color: #0e90d2;"></i> ${window.i18n.tools.border.customBorder}
                </a>
            </li>`);
        let content=null;

...
export default class ZxingTool extends Tool{
    ...
    buildButton(){
        ...
        const mainBtn=$(`<button type="button" class="btn btn-default dropdown-toggle" style="border:none;border-radius:0;background: #f8f8f8;padding: 6px 5px;" data-toggle="dropdown" title="${window.i18n.tools.zxing.title}">
            <i class="easyreport easyreport-qrcode" style="color: #0e90d2;"></i>
            <span class="caret"></span>
        </button>`);
        const ul=$(`<ul class="dropdown-menu" role="menu"></ul>`);
        const qrcode=$(`<li>
                <a href="###">
                    <i class="easyreport easyreport-qrcode" style="color: #0e90d2;"></i> ${window.i18n.tools.zxing.qrcode}
                </a>
            </li>`);
        ul.append(qrcode);
        ...
        const barcode=$(`<li>
                <a href="###">
                    <i class="easyreport easyreport-barcode" style="color: #0e90d2;font-size: 16px"></i> ${window.i18n.tools.zxing.barcode}
                </a>
            </li>`);
        ul.append(barcode);

...
export default class AlignLeftTool extends Tool{
    ...
    buildButton(){
        ...
        const nameButton=$(`<button type="button" class="btn btn-default"
            ...
            <i class="easyreport easyreport-alignleft" id="align_button" style="color: #0e90d2;"></i>
            </button>`);
        ...
        const left=$(`<li>
                <a href="###">
                    <i class="easyreport easyreport-alignleft" style="color: #0e90d2;"></i> ${window.i18n.tools.alignLeft.leftAlign}
                </a>
            </li>`);
        ul.append(left);
        ...
        const center=$(`<li>
                <a href="###">
                    <i class="easyreport easyreport-aligncenter" style="color: #0e90d2;"></i> ${window.i18n.tools.alignLeft.centerAlign}
                </a>
            </li>`);
        ...
        const right=$(`<li>
                <a href="###">
                    <i class="easyreport easyreport-alignright" style="color: #0e90d2;"></i> ${window.i18n.tools.alignLeft.rightAlign}
                </a>
            </li>`);
    ...
    refresh(startRow,startCol,endRow,endCol){
        ...
        for(let i=startRow;i<=endRow;i++) {
            for (let j = startCol; j <= endCol; j++) {
                ...
                $("#align_button").removeClass().addClass("easyreport easyreport-align"+align);
                this.align=align;
                break;
            }
            break;
    ...
    getIcon(){
        return `<i class="easyreport easyreport-alignleft" style="color: #0e90d2;"></i>`;
    }
}
...
export default class ChartTool extends Tool{
    ...
    buildButton(){
        ...
        const mainBtn=$(`<button type="button" class="btn btn-default dropdown-toggle" style="border:none;border-radius:0;background: #f8f8f8;padding: 6px 5px;" data-toggle="dropdown" title="${window.i18n.tools.chart.chart}">
            <i class="easyreport easyreport-pie" style="color: #0e90d2;"></i>
            <span class="caret"></span>
        </button>`);
        const ul=$(`<ul class="dropdown-menu" role="menu"></ul>`);
        const pie=$(`<li>
                <a href="###">
                    <i class="easyreport easyreport-pie" style="color: #0e90d2;"></i> ${window.i18n.tools.chart.pie}
                </a>
            </li>`);
        ul.append(pie);
        pie.click(function(){
        ...
        const doughnut=$(`<li>
                <a href="###">
                    <i class="easyreport easyreport-doughnut" style="color: #0e90d2;"></i> ${window.i18n.tools.chart.doughnut}
                </a>
            </li>`);
        ul.append(doughnut);
        ...
        const line=$(`<li>
                <a href="###">
                    <i class="easyreport easyreport-line" style="color: #0e90d2;"></i> ${window.i18n.tools.chart.line}
                </a>
            </li>`);
        ul.append(line);
        line.click(function(){
        ...
        const bar=$(`<li>
                <a href="###">
                    <i class="easyreport easyreport-bar" style="color: #0e90d2;"></i> ${window.i18n.tools.chart.bar}
                </a>
            </li>`);
        ul.append(bar);
        bar.click(function(){
        ...
        const horBar=$(`<li>
                <a href="###">
                    <i class="easyreport easyreport-horizontal-bar" style="color: #0e90d2;"></i> ${window.i18n.tools.chart.horizontalBar}
                </a>
            </li>`);
        ul.append(horBar);
        ...
        const area=$(`<li>
                <a href="###">
                    <i class="easyreport easyreport-area" style="color: #0e90d2;"></i> ${window.i18n.tools.chart.area}
                </a>
            </li>`);
        ul.append(area);
        area.click(function(){
        ...
        const radar=$(`<li>
                <a href="###">
                    <i class="easyreport easyreport-radar" style="color: #0e90d2;"></i> ${window.i18n.tools.chart.radar}
                </a>
            </li>`);
        ul.append(radar);
        ...
        const polar=$(`<li>
                <a href="###">
                    <i class="easyreport easyreport-polar" style="color: #0e90d2;"></i> ${window.i18n.tools.chart.polar}
                </a>
            </li>`);
        ul.append(polar);
        ...
        const scatter=$(`<li>
                <a href="###">
                    <i class="easyreport easyreport-scatter" style="color: #0e90d2;"></i> ${window.i18n.tools.chart.scatter}
                </a>
            </li>`);
        ul.append(scatter);
        ...
        const bubble=$(`<li>
                <a href="###">
                    <i class="easyreport easyreport-bubble" style="color: #0e90d2;"></i> ${window.i18n.tools.chart.bubble}
                </a>
            </li>`);
        ul.append(bubble);

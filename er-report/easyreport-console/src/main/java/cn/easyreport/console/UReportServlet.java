...
public class UReportServlet extends HttpServlet {
	...
	public static final String URL = "/easyreport";
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (targetUrl.length() < 1) {
			outContent(resp, "Welcome to use EasyReport,please specify target url.");
			return;
		}
		...
		try{
			...
			if(!resp.isCommitted()){
				try{
					...
					// Response already committed or getOutputStream already called

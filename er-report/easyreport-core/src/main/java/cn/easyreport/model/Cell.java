...
import cn.easyreport.definition.BlankCellInfo;
import cn.easyreport.definition.Border;
import cn.easyreport.definition.CellStyle;
import cn.easyreport.definition.ConditionCellStyle;
import cn.easyreport.definition.ConditionPaging;
import cn.easyreport.definition.ConditionPropertyItem;
import cn.easyreport.definition.Expand;
import cn.easyreport.definition.LinkParameter;
import cn.easyreport.definition.PagingPosition;
import cn.easyreport.definition.Scope;
...
public class Cell implements ReportCell {
	...
	public String buildLinkParameters(Context context){
		...
		// 首先添加原始URL参数
		Map<String,Object> originalParams = context.getOriginalUrlParameters();

...
import cn.easyreport.build.aggregate.Aggregate;
import cn.easyreport.build.aggregate.AvgAggregate;
import cn.easyreport.build.aggregate.CountAggregate;
import cn.easyreport.build.aggregate.CustomGroupAggregate;
import cn.easyreport.build.aggregate.GroupAggregate;
import cn.easyreport.build.aggregate.MaxAggregate;
import cn.easyreport.build.aggregate.MinAggregate;
import cn.easyreport.build.aggregate.RegroupAggregate;
import cn.easyreport.build.aggregate.ReselectAggregate;
import cn.easyreport.build.aggregate.SelectAggregate;
import cn.easyreport.build.aggregate.SumAggregate;
import cn.easyreport.definition.value.AggregateType;
import cn.easyreport.exception.CellComputeException;

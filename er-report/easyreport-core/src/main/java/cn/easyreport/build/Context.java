...
import cn.easyreport.definition.mapping.MappingType;
import cn.easyreport.definition.value.SimpleValue;
import cn.easyreport.definition.value.Value;
import cn.easyreport.exception.CellDependencyException;
import cn.easyreport.exception.DatasetUndefinitionException;
...
import cn.easyreport.utils.ElCompute;
...
public class Context {
	...
	private Map<String,Object> originalUrlParameters=new HashMap<String,Object>();
	...
	public List<String> getDatasetFields(String name){
		if(datasetMap.containsKey(name)){
			return datasetMap.get(name).getFields();
		}
		throw new DatasetUndefinitionException(name);
	}
	...
	public void setOriginalUrlParameters(Map<String,Object> originalUrlParameters) {
		if(originalUrlParameters != null) {
			this.originalUrlParameters = originalUrlParameters;
		}
	}
	
	public Map<String,Object> getOriginalUrlParameters() {
		return originalUrlParameters;
	}
}

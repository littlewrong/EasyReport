...
public class CellStyleContext {
	...
	private BorderStyle getBorderStyle(Border border){
		if(border.getStyle().equals(cn.easyreport.definition.BorderStyle.solid)){
			return BorderStyle.THIN;
		}else if(border.getStyle().equals(cn.easyreport.definition.BorderStyle.dashed)){
			return BorderStyle.DASHED;
		}else if(border.getStyle().equals(cn.easyreport.definition.BorderStyle.doublesolid)){

...
public class HtmlReport {
	...
	private List<Map<String,Object>> httpDatasetConfigs;
	private Map<String,Object> apiPagingConfig;
	...
	public List<Map<String, Object>> getHttpDatasetConfigs() {
		return httpDatasetConfigs;
	}
	public void setHttpDatasetConfigs(List<Map<String, Object>> httpDatasetConfigs) {
		this.httpDatasetConfigs = httpDatasetConfigs;
	}
	public Map<String, Object> getApiPagingConfig() {
		return apiPagingConfig;
	}
	public void setApiPagingConfig(Map<String, Object> apiPagingConfig) {
		this.apiPagingConfig = apiPagingConfig;
	}
}

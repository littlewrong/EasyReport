...
import cn.easyreport.chart.Chart;
import cn.easyreport.chart.axes.BaseAxes;
import cn.easyreport.chart.axes.ScaleLabel;
import cn.easyreport.chart.axes.impl.XAxes;
import cn.easyreport.chart.axes.impl.YAxes;
import cn.easyreport.chart.dataset.CollectType;
import cn.easyreport.chart.dataset.Dataset;
import cn.easyreport.chart.dataset.impl.BubbleDataset;
import cn.easyreport.chart.dataset.impl.ScatterDataset;
import cn.easyreport.chart.dataset.impl.category.AreaDataset;
import cn.easyreport.chart.dataset.impl.category.BarDataset;
import cn.easyreport.chart.dataset.impl.category.CategoryDataset;
import cn.easyreport.chart.dataset.impl.category.DoughnutDataset;
import cn.easyreport.chart.dataset.impl.category.HorizontalBarDataset;
import cn.easyreport.chart.dataset.impl.category.LineDataset;
import cn.easyreport.chart.dataset.impl.category.PieDataset;
import cn.easyreport.chart.dataset.impl.category.PolarDataset;
import cn.easyreport.chart.dataset.impl.category.RadarDataset;
import cn.easyreport.chart.dataset.impl.category.SeriesType;
import cn.easyreport.chart.option.Easing;
import cn.easyreport.chart.option.Option;
import cn.easyreport.chart.option.Position;
import cn.easyreport.chart.option.impl.AnimationsOption;
import cn.easyreport.chart.option.impl.LegendOption;
import cn.easyreport.chart.option.impl.TitleOption;
import cn.easyreport.chart.plugins.DataLabelsPlugin;
import cn.easyreport.definition.value.ChartValue;

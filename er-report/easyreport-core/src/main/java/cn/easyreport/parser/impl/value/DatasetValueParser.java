...
import cn.easyreport.definition.Order;
import cn.easyreport.definition.mapping.MappingItem;
import cn.easyreport.definition.mapping.MappingType;
import cn.easyreport.definition.value.AggregateType;
import cn.easyreport.definition.value.DatasetValue;
import cn.easyreport.definition.value.GroupItem;
...
public class DatasetValueParser extends ValueParser {
	...
	public Value parse(Element element) {
		...
		String useIndex=element.attributeValue("use-index");
		if(StringUtils.isNotBlank(useIndex)){
			value.setUseIndex(Boolean.valueOf(useIndex));
		}
		String index=element.attributeValue("index");
		if(StringUtils.isNotBlank(index)){
			value.setIndex(Integer.valueOf(index));
		}
